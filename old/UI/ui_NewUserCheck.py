...
class Ui_NewUserCheck(object):
    def setupUi(self, NewUserCheck):
        ...
        self.lineLeft.setStyleSheet(
            u"background-color: rgb(176, 176, 176);\n" "border: 0px;"
        )
        ...
        self.labelGuideName.setAlignment(
        ...
        self.labelUserContact.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter
        )
        ...
        self.labelGuideContact.setAlignment(
            Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter
        )
        ...
        self.labelGuideID.setAlignment(
            Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter
        )
        ...
        self.buttonReturn.setStyleSheet(
            u"QPushButton\n"
            "{\n"
        ...
        self.DLabelNFCTitle.setStyleSheet(
        ...
        self.DLabelNFCIcon.setStyleSheet(
        ...
        self.DButtonSkip.setStyleSheet(
            u'font: 18pt "\ubc30\ub2ec\uc758\ubbfc\uc871 \uc8fc\uc544";\n'
            "color: rgb(232, 77, 33);\n"
            "background-color: rgb(255, 255, 255);"
        )
        ...
        self.DLabelNFCGuide.setStyleSheet(
            u'font: 20pt "\ubc30\ub2ec\uc758\ubbfc\uc871 \uc8fc\uc544";\n'
            "background-color: rgb(255, 255, 255);\n"
            "color: rgb(71, 71, 71);"
        )
        self.DLabelNFCGuide.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter
        )
    ...
    def retranslateUi(self, NewUserCheck):
        NewUserCheck.setWindowTitle(
            QCoreApplication.translate("NewUserCheck", u"Form", None)
        )
        self.buttonHome.setText(QCoreApplication.translate("NewUserCheck", u"HH", None))
        self.labelMenu.setText(
            QCoreApplication.translate(
                "NewUserCheck", u"\uc0ac\uc6a9\uc790 \ub4f1\ub85d", None
            )
        )
        self.labelHome.setText(
            QCoreApplication.translate("NewUserCheck", u"\ud648", None)
        )
        ...
        self.labelGuideName.setText(
            QCoreApplication.translate("NewUserCheck", u"\uc774\ub984 :", None)
        )
        self.labelUserName.setText(
            QCoreApplication.translate("NewUserCheck", u"\uc774\uc9c4\uc601", None)
        )
        ...
        self.labelUserContact.setText(
            QCoreApplication.translate("NewUserCheck", u"010 - 4047 - 9089", None)
        )
        self.labelGuideContact.setText(
            QCoreApplication.translate(
                "NewUserCheck", u"\uc804\ud654\ubc88\ud638 :", None
            )
        )
        self.labelUserID.setText(
            QCoreApplication.translate("NewUserCheck", u"2019311737", None)
        )
        self.labelGuideID.setText(
            QCoreApplication.translate("NewUserCheck", u"\ud559\ubc88 :", None)
        )
        self.buttonTemp.setText("")
        self.buttonRegister.setText(
            QCoreApplication.translate("NewUserCheck", u"\ub4f1\ub85d", None)
        )
        self.buttonReturn.setText("")
        # if QT_CONFIG(accessibility)
        self.DialogueShadow.setAccessibleName("")
        # endif // QT_CONFIG(accessibility)
        self.DLabelNFCTitle.setText(
            QCoreApplication.translate(
                "NewUserCheck", u"NFC \ub4f1\ub85d \uc911...", None
            )
        )
        self.DLabelNFCIcon.setText("")
        self.DButtonSkip.setText(
            QCoreApplication.translate("NewUserCheck", u"SKIP", None)
        )
        self.DLabelNFCGuide.setText(
            QCoreApplication.translate(
                "NewUserCheck",
                u"NFC\ub97c \ucf1c\uace0\n"
                "\ub2e8\ub9d0\uae30\uc5d0 \ud0dc\uadf8\ud574\uc8fc\uc138\uc694",
